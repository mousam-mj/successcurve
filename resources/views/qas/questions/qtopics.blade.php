                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('qas/qts/add') }}" method="POST"  class="form-group">
                                @csrf
                ...
                <div class="modal fade" id="updateModel" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('qas/qts/update') }}" method="POST"  class="form-group">
                                @csrf
                        ...
                        <tbody>
                            @foreach($qts as $qb)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('qas/sqts/'.$qb['qtId']) }}" class="text-info">
                                            {!! $qb['qtName'] !!} </a>
                                    </td>
                                    <td>{{ $qb['tqnos'] }}</td>
                                    <td class="text-center">
                                        ...
                                        @if($status == 0)
                                          <a class="text-danger btn-sm" href="{{ url('qas/qts/remove/'.$qb['qtId']) }}">
                                              <i class="far fa-trash-alt"></i>
                                          </a>
                                        @elseif($status == 1)
                                          <a href="{{ url('qas/qts/restore/'.$qb['qtId']) }}" class="text-success btn-sm">
                                            <i class="far fa-trash-undo"></i>
                                          </a>
                    
                                          <a class="text-danger btn-sm" onclick="confirm('Are you sure want to delete?');" href="{{ url('qas/qts/delete/'.$qb['qtId']) }}">
                                            <i class="far fa-trash-alt"></i>
                                          </a>
                                        @endif()
