        ...
        <div class="col-md-9 col-12 dash-container">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title" style="float: left;">User List | {{ $cls->className }}</h3>

                <div class="card-tools" style="float: right;">
                    <a class="btn btn-success btn-sm" href="{{ url('admin/cls/users/export/'.$cls->classId) }}">Export Users</a>
                </div>
              </div>
