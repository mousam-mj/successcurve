    ...
    <div  class="row">
        ...
        <div class="col-md-9 col-12 dash-container">
            <div class="dash-header">
                <h3 class="dash-header-title">Add New Instructor</h3>
            </div>
            <div class="dash-form-box">
                <form action="{{URL('admin/addInstructor')}}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="form-group">
                        <label for="password" class="ds-label"><i class="far fa-image"></i> Image</label>
                        <input type="file" class="form-control" name="image" id="image">
                    </div>
                    <div class="form-group">
                        <button type="submit" class="btn btn-custom3 form-control">Add Instructor</button>
                    </div>
                </form>
            </div>
        </div>
