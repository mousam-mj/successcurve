                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <form action="{{ url('admin/updateClass') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body">
                                <div class="form-group">
                            ...
                            @foreach($tcs as $tc)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="hidden" value="{{ $tc->classId }}" id="tcidb<?php echo $count;?>">
                                        <input type="hidden" value="{{ $tc->className }}" id="tcnb<?php echo $count;?>">
                                    ...
                                    <td>
                                        <a class="btn-sm text-danger" href="{{ url('admin/deleteClass/'.$tc->classId) }}"><i class="far fa-trash-alt"></i></a>

                                        <a href="{{ url('admin/cls/users/'.$tc->classId) }}" class="text-success">
