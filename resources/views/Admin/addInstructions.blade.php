...
<!--            Error Box       -->
            ...
            <div class="dash-header">
                <h3 class="dash-header-title">Add Test Instructions</h3>
            </div>
            <div class="dash-form-box">
                <form action="{{URL('admin/addIns')}}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-custom3 form-control">Add Instruction</button>
                    </div>
                </form>
            </div>        
      <!--        Container End   -->  
