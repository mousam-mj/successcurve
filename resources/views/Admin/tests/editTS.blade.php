...
<!--            Error Box       -->
            ...
            {{-- <div class="dash-form-box"> --}}
                ...
                <form action="{{ url('admin/tests/updateTc') }}" method="post" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group pl-10" id="costbox">
                                        ...
                                        <input type="number" step='0.01' placeholder='40.00' name="ucost" id="ucost" class="form-control" value="{{ $tcs->tcPrice }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group" id="validtybox">
                                        <label for="validity" class="ds-label"><i class="far fa-rupee-sign"></i> Validity</label>
                                        <input type="number" placeholder='' name="validity" id="validity" value="{{ $tcs->tcValidity }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
