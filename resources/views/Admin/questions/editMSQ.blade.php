...
<!--            Error Box       -->
            ...
            <div class="dash-header">
                <span class="dash-header-title">Update MSQ Question</span>
            ...
            {{-- <div class="dash-form-box"> --}}
                <form action="{{URL('admin/qns/msq/updateQns')}}" method="post" enctype="multipart/form-data">
                @csrf
                  ...
                  <input type="hidden" name="qwId" value="{{ $qls->qwId }}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group pr-10">
                                    ...
                                    <input class="form-control" id="correctAns" name="correctAns" placeholder="1,2,3" value="{{ $qls->qwCorrectAnswer }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-custom3 form-control">Update MSQ Question</button>
                    </div>
                </form>
            {{-- </div> --}}
      <!--        Container End   -->
