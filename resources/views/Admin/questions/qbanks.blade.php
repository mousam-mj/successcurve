        ...
        <div class="col-md-9 col-12 dash-container">
            ...
            <div class="card">
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('admin/qbs/add') }}" method="POST"  class="form-group">
                                @csrf
                ...
                <div class="modal fade" id="updateModel" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('admin/qbs/update') }}" method="POST"  class="form-group">
                                @csrf
                                <div class="form-group">
                        ...
                        <tbody>
                            @foreach($qbs as $qb)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('admin/sqbs/'.$qb['qbId']) }}" class="text-info">
                                            {!! $qb['qbName'] !!} </a>
                                    </td>
                                    <td>
                                      {{ $qb['tqnos'] }}
                                    ...
                                    <td class="text-center">
										...
										@if ($status == 1)
											<a class="text-danger btn-sm" href="{{ url('admin/qbs/remove/'.$qb['qbId']) }}">
												<i class="far fa-trash-alt"></i>
											</a>
										@elseif($status == 0)
											
											<a href="{{ url('admin/qbs/restore/'.$qb['qbId']) }}" class="text-success btn-sm">
												<i class="far fa-trash-undo"></i>
											</a>

											<a class="text-danger btn-sm" onclick="confirm('Are you sure want to delete?');" href="{{ url('admin/qbs/delete/'.$qb['qbId']) }}">
												<i class="far fa-trash-alt"></i>
											</a>
										@endif
              ...
              <div class="card-footer">
				  @if($status == 1) 
				  	<a href="{{ url('admin/qbs/trash') }}" class="text-danger"> <i class="fas fa-trash-alt"></i> Trash </a>
				  @elseif ($status == 0)
				  	<a href="{{ url('admin/qbs') }}" class="text-primary"> <i class="far fa-arrow-circle-left"></i> Question Banks </a>
				  @endif
