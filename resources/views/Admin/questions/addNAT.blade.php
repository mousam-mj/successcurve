...
<!--            Error Box       -->
            ...
            <div class="dash-header">
                <span class="dash-header-title">Add NAT Question</span>
            ...
            {{-- <div class="dash-form-box"> --}}
                <form action="{{URL('admin/qns/nat/addQns')}}" method="post" enctype="multipart/form-data">
                @csrf
                  ...
                  <input type="hidden" name="qlId" value="{{ $qls->qlId }}">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-custom3 form-control">Add NAT Question</button>
                    </div>
                </form>
            {{-- </div> --}}
      <!--        Container End   -->
