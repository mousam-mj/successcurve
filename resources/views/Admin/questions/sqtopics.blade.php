        ...
        <div class="col-md-9 col-12 dash-container">
            ...
            <div class="card">
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('admin/sqts/add') }}" method="POST"  class="form-group">
                                @csrf
                ...
                <div class="modal fade" id="updateModel" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('admin/sqts/update') }}" method="POST"  class="form-group">
                                @csrf
                        ...
                        <tbody>
                            @foreach($sqts as $qb)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('admin/qls/'.$qb['qtId']) }}" class="text-info">
                                            {!! $qb['qtName'] !!} </a>
                                    </td>
                                    <td>{{ $qb['tqnos'] }}</td>
                                    <td class="text-center">
                                        ...
                                        @if( $status == 1)
                                          <a href="{{ url('admin/sqts/restore/'.$qb['qtId']) }}" class="text-success btn-sm">
                                            <i class="far fa-trash-undo"></i>
                                          </a>
                    
                                          <a class="text-danger btn-sm" onclick="confirm('Are you sure want to delete?');" href="{{ url('admin/sqts/delete/'.$qb['qtId']) }}">
                                            <i class="far fa-trash-alt"></i>
                                          </a>
                                        @elseif($status == 0 )
                                          <a class="text-danger btn-sm" href="{{ url('admin/sqts/remove/'.$qb['qtId']) }}">
                                            <i class="far fa-trash-alt"></i>
                                        </a>
                                        @endif
              ...
              <div class="card-footer">
                ...
                @if($status == 0) 
                  <a href="{{ url('admin/sqts/trash/'.$qts->qtId) }}" class="text-danger"> <i class="fas fa-trash-alt"></i> Trash </a>
                @elseif ($status == 1)
                  <a href="{{ url('admin/sqts/'.$qts->qtId) }}" class="text-primary"> <i class="far fa-arrow-circle-left"></i> Sub Topics </a>
                @endif
