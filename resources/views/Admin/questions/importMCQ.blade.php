...
@extends('layout')
@section('title')
Upload MCQ Question | {{ $qls->qlName }}
@endsection
@section('content')
        ...
        <div class="col-md-9 col-12 dash-container">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title" style="float: left;">Upload MCQ Questions | {{ $qls->qlName }}</h3>
              ...
              <div class="card-body">
                    <form method="post" action="{{ url('admin/qns/mcq/up/add') }}" enctype="multipart/form-data">
                        @csrf
