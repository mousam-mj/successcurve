...
<!--            Error Box       -->
            ...
            <div class="dash-header">
                <span class="dash-header-title">Update MCQ Question</span>
            ...
            {{-- <div class="dash-form-box"> --}}
                <form action="{{URL('admin/qns/mcq/updateQns')}}" method="post" enctype="multipart/form-data">
                @csrf
                  ...
                  <input type="hidden" name="qwId" value="{{ $qls->qwId }}">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-custom3 form-control">Update MCQ Question</button>
                    </div>
                </form>
            {{-- </div> --}}
      <!--        Container End   -->
