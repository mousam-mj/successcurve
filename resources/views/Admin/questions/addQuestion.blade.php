...
<!--            Error Box       -->
            ...
            <div class="dash-header">
                <span class="dash-header-title">Add Question</span>
            ...
            <div class="dash-form-box">
                <form action="{{URL('admin/qns/addQns')}}" method="post" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group pr-10">
                                    ...
                                    <select name="questiontype" id="questiontype" class="form-control">
                                        <option value="radio" selected>Multiple Choice Single Answer</option>
                                        <option value="checkbox">Multiple Choice Multi Answer</option>
                                        <option value="paragraph">Paragraph Type</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" id="prid">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="paragraphid" id="paragraphid" placeholder="Paragraph Id" class="form-control">
                                </div>
                            </div>
