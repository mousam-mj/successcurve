...
<!--            Error Box       -->
            ...
            <div class="dash-header">
                <span class="dash-header-title">Add PR Question</span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" id="prid">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="paragraphid" id="paragraphid" placeholder="Paragraph Id" class="form-control" required>
                                </div>
                            </div>
