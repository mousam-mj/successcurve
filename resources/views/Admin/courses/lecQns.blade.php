            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools" style="float: right;">
                    <a class="btn btn-primary" href="{{ url('admin/lession/qns/add/'.$lecs->lectureId) }}">Add New</a>
                </div>
              </div>
                            ...
                            @foreach($qns as $que)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-danger btn-sm" href="{{ url('admin/lession/qns/remove'.$que->qwId.'/'.$lecs->lectureId) }}">
