        ...
        <div class="col-md-9 col-12 dash-container">
            ...
            <div class="card">
                <div class="card-header">
                    <form action="{{ url('admin/course/filter') }}" method="GET" class="form-inline">
              ...
              <div class="card-header">
                ...
                <div class="card-tools" style="float: right;">
                    <a class="btn btn-primary btn-sm" href="{{ url('admin/courses/new/') }}">Add New</a>
                </div>
              </div>
                            ...
                            @foreach($courses as $course)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="text-danger btn-sm" href="{{ url('admin/courses/remove/'.$course->courseId) }}">
                                            <i class="far fa-trash-alt"></i>
                                        </a>

                                        <a href="{{ url('admin/courses/users/'.$course->courseId) }}" class="text-success">
