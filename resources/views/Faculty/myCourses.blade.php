                ...
                <div class="c-link">
                    <div class="course-div">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a class="text-center text-danger" href="{{ url('faculty/removeCourse')}}/?courseId={{$product->courseId}}">
                                    <i class="fas fa-trash-alt"></i> Remove
                                </a>
                            </div>
                            <div class="col-md-6">                               
                                <a class="text-center text-primary" href="{{ url('faculty/editCourses')}}/?courseId={{$product->courseId}}">
