...
<!--            Error Box       -->
            ...
            <div class="dash-form-box">
                <form action="{{URL('faculty/editCoursesContent')}}" method="post" enctype="multipart/form-data">
                @csrf
                   @foreach($courses as $course)
                    ...
                    <div class="form-group">
                        <label for="instructor" class="ds-label"><i class="fas fa-user-plus"></i> Add Instructor (optional)</label>
