...
//            console.log(dataResult);
    ...
    var url = "{{url('faculty/getTopCourse')}}";
    
    $.get(url, function(response){
            response.forEach(function(data){
                Course.push(data.courseTitle.substr(1, 10));
    ...
    var url = "{{url('faculty/getTopTests')}}";
    $.get(url, function(response){
            response.forEach(function(data){
                Tests.push(data.tName.substr(1,10));
