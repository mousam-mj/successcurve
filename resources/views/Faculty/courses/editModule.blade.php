...
<!--            Error Box       -->
            ...
            <div class="dash-header">
                <h3 class="dash-header-title">Edit Module</h3>
            </div>
            <div class="dash-form-box">
                <form action="{{URL('faculty/editModuleContent')}}" method="post">
                @csrf
                    ...
                    <div class="form-group">
                        <label for="name" class="ds-label"><i class="fas fa-clipboard"></i> New Module Name</label>
                        <input type="text" class="form-control" name="name" id="name" required>
                    </div>
                    <div class="form-group">
                        <button type="submit" class="btn btn-custom3 form-control">Update Module</button>
                    </div>
                </form>
            </div>        
      <!--        Container End   -->  
