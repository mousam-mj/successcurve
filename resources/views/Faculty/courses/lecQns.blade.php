        ...
        <div class="col-md-9 col-12 dash-container">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title" style="float: left;">Questions | {{ $lecs->lectureTitle }}</h3>

                <div class="card-tools" style="float: right;">
                    <a class="btn btn-primary" href="{{ url('faculty/lession/qns/add/'.$lecs->lectureId) }}">Add New</a>
                </div>
              </div>
                            ...
                            @foreach($qns as $que)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-danger btn-sm" href="{{ url('faculty/lession/qns/remove/'.$que->qwId.'/'.$lecs->lectureId) }}">
