                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{URL('faculty/addModule')}}" method="post">
                                @csrf
                        ...
                        <tbody>
                            ...
                            @foreach($modules as $course)
                                <tr>
                                    <td>{{ $course->weekId }}</td>
                                    <td>
                                        <a href="{{ url('faculty/courses/lectures/'.$course->weekId) }}" class="text-info">
                                            {!! $course->weekName !!}
                                        </a>
                                    </td>
                                   
                                    <td class="text-center">
                                        <a class="text-info btn-sm" href="{{ url('faculty/modules/edit/'. $course->weekId) }}">
                                            <i class="far fa-edit"></i>
                                        </a>
                                        <a class="text-danger btn-sm" href="{{ url('faculty/modules/remove/'.$course->weekId) }}">
