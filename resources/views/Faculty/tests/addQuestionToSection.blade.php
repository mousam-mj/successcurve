...
$(document).ready(function() {
    ...
    $.ajax({
        url: "{{ URL('faculty/getquestionbanks')}}",
        type: "POST",
        data:{
            _token: '{{csrf_token()}}'
        },
...
function changeQuestion(pqbs = 0, qbs = 0, pqts = 0, qts = 0, qls = 0, qtype = 'mcq'){
    ...
    $.ajax({
        url: "{{ URL('faculty/getTopicQuestions')}}",
        type: "POST",
        data:{
            _token:'{{ csrf_token() }}',
            pqbId: pqbs,
...
function addQuestion(qid){
    ...
    $.ajax({
        url: "{{ URL('faculty/addSectionQuestion')}}",
        type: "POST",
        data:{
            _token:'{{ csrf_token() }}',
            qid: qid,
