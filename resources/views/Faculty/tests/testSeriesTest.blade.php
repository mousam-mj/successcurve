            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools" style="float: right;">
                    <a class="btn btn-primary" href="{{URL('faculty/addTestToSeries/'.$tcs->tcId)}}">Add New</a>
                </div>
              </div>
            <div class="card-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example1">
                        ...
                        <tbody id="tests">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-danger btn-sm" href="{{ url('faculty/removeTestFromSeries/'.$tst->tstId.'/'.$tst->tId) }}">
