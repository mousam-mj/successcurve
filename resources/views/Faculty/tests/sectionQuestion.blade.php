            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools" style="float: right;">
                    <a class="btn btn-primary" href="{{ url('faculty/addQuestionToSection/'.$tsecs->tsecId) }}">Add New</a>
                </div>
              </div>
                            ...
                            @foreach($ques as $que)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-danger btn-sm" href="{{ url('faculty/removeSectionQuestion/'.$que->qwId.'/'.$tsecs->tsecId) }}">
