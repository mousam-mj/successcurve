                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <form action="{{ url('faculty/addTestSection') }}" method="post">
                            @csrf
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <form action="{{ url('faculty/updateTestSection') }}" method="post">
                            @csrf
                            <div class="modal-body">
                        ...
                        <tbody>
                            ...
                            @foreach($tcs as $tc)
                                <tr>
                                    <td>{{ $tc->tsecId }}</td>
                                    <td>
                                        <a class="text-info" href="{{ url('faculty/sectionQuestion/'.$tc->tsecId) }}">
                                            {{ $tc->tsecName }}
                                        </a>
                                    </td>
                                    <td>{{ $tc->tsMarks }}</td>
